...
// This HTML task is basically just for browser-sync, so that we can easily
// test the web pages on the other devices in development.
...
/* This plugin will convert the ejs to html, just experimental only. 
The purpose is just test web app in browser sync.*/
...
/*««««««««««««««««««««««««««««««««««««««««««««««««*/
var jsSrc= [
  // "./components/javascript/app.js",
  // "./components/javascript/controllers.js",
  "./components/javascript/header.js",
  "./components/javascript/section.js"
...
var libSrc= [ 
    ...
    './components/lib/jquery-migrate/index.js', // use in development only
    './components/lib/modernizer/modernizer.js',
    './components/lib/bootstrap/dist/js/bootstrap.js',// jQuery dependency
    // './components/lib/typed.js/js/typed.js',
    './components/lib/wow/dist/wow.js', // animate.css in a dependency
    // './components/lib/Snap.svg/dist/snap.svg.js',
    // './components/customLibs/single-page-nav/jquery.singlePageNav.js' // jquery dependency
];
...
// gulp Default task
//««««««««««««««««««««
gulp.task('default', ['sass', "nodemon", "lint", "html", 'ejs', 'concatJs', 'concatLibs', 'concatCssLibs', 'watch', 'serverDev', 'image_min']);

gulp.task('production', ['uglifyJs', 'concatMinLibs', 'minifyCss', 'concatMinCssLibs']);

gulp.task('cleanTask', ['clean', 'cleanLibs']);
